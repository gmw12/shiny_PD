norm_prep <- function(){
  ...
  if ((dpmsr_set$x$raw_data_input=="Protein_Peptide" || dpmsr_set$x$raw_data_input=="Peptide") 
    ...
    dpmsr_set$data$norm_data <<- dpmsr_set$data$norm_data[(dpmsr_set$y$info_columns+1):ncol(dpmsr_set$data$norm_data)]
    dpmsr_set$data$data_annotate <<- dpmsr_set$data$data_peptide[1:dpmsr_set$y$info_columns]
    dpmsr_set$data$data_to_norm <<- dpmsr_set$data$data_peptide[(dpmsr_set$y$info_columns+1):dpmsr_set$y$total_columns]
  }
  ...
  if ((dpmsr_set$x$raw_data_input=="Protein_Peptide" || dpmsr_set$x$raw_data_input=="Peptide") 
    ...
    Simple_Excel(dpmsr_set$data$norm_data,  str_c(dpmsr_set$file$extra_prefix, "_norm_data.xlsx", collapse = " "))
    dpmsr_set$data$norm_data <<- dpmsr_set$data$norm_data[(dpmsr_set$y$info_columns+1):ncol(dpmsr_set$data$norm_data)]
    dpmsr_set$data$data_annotate <<- dpmsr_set$data$data_peptide_isoform[1:dpmsr_set$y$info_columns]
    dpmsr_set$data$data_to_norm <<- dpmsr_set$data$data_peptide_isoform[(dpmsr_set$y$info_columns+1):dpmsr_set$y$total_columns]
  }
  ...
  if (dpmsr_set$x$raw_data_input=="Protein") {
    ...
    Simple_Excel(dpmsr_set$data$norm_data,  str_c(dpmsr_set$file$extra_prefix, "_norm_data.xlsx", collapse = " "))
    dpmsr_set$data$norm_data <<- dpmsr_set$data$norm_data[(dpmsr_set$y$info_columns+1):ncol(dpmsr_set$data$norm_data)]
    dpmsr_set$data$data_annotate <<- dpmsr_set$data$data_protein[1:dpmsr_set$y$info_columns]
    dpmsr_set$data$data_to_norm <<- dpmsr_set$data$data_protein[(dpmsr_set$y$info_columns+1):dpmsr_set$y$total_columns]
  }
...
protein_normalize <- function(data_to_norm, data_title){
  protein_norm_raw <- cbind(dpmsr_set$data$data_annotate, data_to_norm)
  protein_norm_raw <-subset(protein_norm_raw, Accession %in% dpmsr_set$x$protein_norm_list)
