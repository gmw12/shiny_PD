      ...
      tabPanel("Normalize", value = "tp_normalize",
               fluidRow(
                 column(width = 4, offset = 1,
                     ...
                     checkboxInput("checkbox_norm_include", label = "Include only grep for norm (trypsin|keratin)"),
                     textInput("include_norm_grep", label = "Filter Include grep", value = "Enter value here"),
                     checkboxInput("checkbox_norm_exclude", label = "Exclude grep from norm (trypsin|keratin|casein)"),
                     textInput("exclude_norm_grep", label = "Filter Exclude grep", value = "trypsin|casein|keratin"),
